...
private SparkMaxPIDController follower_pidController;
  ...
  private ExampleFlywheel() {
    ...
    followerFlywheel = new CANSparkMax(RobotMap.FlywheelMap.FOLLOWER_FLYWHEEL, MotorType.kBrushless);
    vision = new PhotonCamera(RobotMap.CameraMap.COMPUTER_VISION);
    
    leaderFlywheel.setInverted(false); // In case one of the motors needs to be invrted before setting them to follow
