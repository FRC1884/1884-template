...
public class RobotMap {
    ...
    public static class DriveMap {
        ...
        public static final Module FRONT_LEFT_MODULE = new Module(7,
                8, 18, 270);

        public static final Module FRONT_RIGHT_MODULE = new Module(1,
                2, 17, 260);

        public static final Module BACK_LEF_MODULE = new Module(5,
                6, 16, 270);

        public static final Module BACK_RIGHT_MODULE = new Module(3,
                4, 19, 265);
    }
